...
class BenServiceTest {
  ...
  public void submitReimbursement(Reimbursements_Ben reimbursements) {
    ...
    Mockito.when(benRepositoryImpl.submitReimbursement())
        .thenReturn(new Reimbursements_Ben(1, "Ben Employee", "pending", "not approved", 2, "work lunch meeting",
            "manager reason"));

    System.out.println(submitReimbursement.get(0));

    List<Reimbursements_Ben> findAll = employeeService.submitReimbursement();
